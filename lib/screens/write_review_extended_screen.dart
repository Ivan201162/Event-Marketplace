    ...
    appBar: AppBar(
      ...
      actions: [
        if (_isLoading)
          ...
          TextButton(onPressed: _submitReview, child: const Text('Отправить')),
      ],
    ),
    body: Form(
      key: _formKey,
      ...
      children: [
        CircleAvatar(
          ...
          child: widget.specialist.imageUrlValue == null
              ? Text(
                  widget.specialist.name.isNotEmpty ? widget.specialist.name[0].toUpperCase() : 'С',
    ...
    children: [
      ...
      Center(
        child: Text(
          ...
          style: Theme.of(
            context,
          ).textTheme.bodyLarge?.copyWith(color: _getRatingColor(), fontWeight: FontWeight.w500),
        ),
      ),
    ],
  );
        ...
        if (widget.booking!.location != null && widget.booking!.location!.isNotEmpty) ...[
          ...
          Row(
            children: [
              ...
              const SizedBox(width: 8),
              Expanded(
                child: Text(widget.booking!.location!, style: const TextStyle(fontSize: 14)),
              ),
            ],
          ),
        ],
