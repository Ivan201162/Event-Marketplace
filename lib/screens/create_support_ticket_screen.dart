...
class _CreateSupportTicketScreenState extends ConsumerState<CreateSupportTicketScreen> {
  ...
  Widget build(BuildContext context) => Scaffold(
    appBar: AppBar(
      ...
      actions: [
        TextButton(onPressed: _isLoading ? null : _submitTicket, child: const Text('Отправить')),
      ],
    ),
    body: Form(
      key: _formKey,
        ...
        children: [
          Row(
            children: [
              ...
              const Spacer(),
              Text('${_attachments.length}/5', style: TextStyle(color: Colors.grey[600])),
            ],
          ),
          const SizedBox(height: 16),
          ...
          if (_attachments.isNotEmpty) ...[
            ...
            ..._attachments.asMap().entries.map((entry) {
              ...
              return Container(
                ...
                child: Row(
                  children: [
                    Icon(_getFileIcon(file.path), color: Colors.grey[600]),
                    const SizedBox(width: 8),
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
