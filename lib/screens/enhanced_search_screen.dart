...
class _EnhancedSearchScreenState extends ConsumerState<EnhancedSearchScreen>
  ...
  Widget _buildCategoriesTab() => SingleChildScrollView(
    ...
    child: Column(
      ...
      children: [
        ...
        const SizedBox(height: 16),
        CategoriesGrid(categories: SpecialistCategoryInfo.all, onCategoryTap: _navigateToCategory),
      ],
    ),
  );
  ...
  void _performSearch() {
    ...
    final updatedFilters = currentFilters.copyWith(searchQuery: query.isEmpty ? null : query);
  ...
  void _navigateToCategory(SpecialistCategoryInfo category) {
    ...
    Future.delayed(const Duration(milliseconds: 500), () {
      ...
      Navigator.of(context).push(
        MaterialPageRoute<void>(builder: (context) => SpecialistsListScreen(category: category)),
      );
    });
  }
