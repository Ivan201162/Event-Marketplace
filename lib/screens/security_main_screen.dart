...
class SecurityMainScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) => Scaffold(
    ...
    body: ListView(
      ...
      children: [
        ...
        _buildSection(title: 'Статистика безопасности', children: [_buildSecurityStatsCard()]),
        ...
        _buildSection(
          ...
          children: [_buildRecommendationsCard()],
        ),

        const SizedBox(height: 24),

        // Информация
        _buildSection(title: 'Информация', children: [_buildInfoCard()]),
      ],
    ),
  );
  ...
  Widget _buildSecurityStatsCard() => Card(
    child: Padding(
      padding: const EdgeInsets.all(16),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
  ...
  Widget _buildRecommendationsCard() => Card(
    child: Padding(
      padding: const EdgeInsets.all(16),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Text('Рекомендации', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
          const SizedBox(height: 16),
  ...
  Widget _buildInfoCard() => Card(
    child: Padding(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Text('О безопасности', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
          const SizedBox(height: 16),
          const Text(
