...
import 'package:event_marketplace_app/models/user.dart' show AppUser, UserRole;
        ...
        children: [
          ...
          Expanded(
            child: userEvents.when(
                              ...
                              children: [
                                Container(
                                  ...
                                  child: Text(
                                    event.statusText,
                                    style: TextStyle(
                                        color: event.statusColor, fontSize: 12,),
                                  ),
                                ),
              ...
              loading: () => const Center(child: CircularProgressIndicator()),
              error: (error, stack) =>
                  Center(child: Text('Ошибка загрузки мероприятий: $error')),
            ),
          ),
        ],
      ),
        ...
        children: [
          ...
          Expanded(
            child: userEvents.when(
              ...
              loading: () => const Center(child: CircularProgressIndicator()),
              error: (error, stack) =>
                  Center(child: Text('Ошибка загрузки проектов: $error')),
            ),
          ),
        ],
      ),
