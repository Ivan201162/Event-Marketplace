...
class _AdminPanelPageState extends ConsumerState<AdminPanelPage>
  ...
  Widget _buildUsersTab() => StreamBuilder<List<AppUser>>(
  ...
  Widget _buildEventsTab() => StreamBuilder<List<Event>>(
  ...
  Widget _buildStatsTab() => StreamBuilder<Map<String, dynamic>>(
  ...
  Widget _buildUserFilters() => Container(
        padding: const EdgeInsets.all(16),
        child: Row(
          children: [
            Expanded(
  ...
  Widget _buildEventFilters() => Container(
        padding: const EdgeInsets.all(16),
        child: Row(
          children: [
            Expanded(
  ...
  Widget _buildUserCard(AppUser user) => Card(
        ...
        child: ListTile(
          ...
          subtitle: Column(
            ...
            children: [
              Text(user.email),
              if (user.bio?.isNotEmpty ?? false) Text(user.bio!),
              Row(
                children: [
                  if (user.isVerified)
                    const Chip(
  ...
  Widget _buildEventCard(Event event) => Card(
        margin: const EdgeInsets.symmetric(horizontal: 16, vertical: 4),
        child: ListTile(
  ...
  Widget _buildStatsCard(String title, Map<String, dynamic> stats) => Card(
        child: Padding(
          padding: const EdgeInsets.all(16),
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
  ...
  Widget _buildSettingsCard(String title, List<Widget> children) => Card(
        child: Padding(
          padding: const EdgeInsets.all(16),
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
  ...
  Future<void> _handleUserAction(String action, AppUser user) async {
    try {
      ...
      SafeLog.error(
        'AdminPanelPage: Error handling user action',
        e,
        stackTrace,
      );
  ...
  Future<void> _handleEventAction(String action, Event event) async {
    try {
      ...
      SafeLog.error(
        'AdminPanelPage: Error handling event action',
        e,
        stackTrace,
      );
      _showErrorMessage('Ошибка: $e');
