          ...
          return SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                if (user.isAdmin) ...[_buildAdminSection(context), const SizedBox(height: 24)],
        ...
        children: [
          ...
          SwitchListTile(
            ...
            onChanged: (value) {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(content: Text('Push-уведомления ${value ? 'включены' : 'отключены'}')),
              );
            },
          ),
          const Divider(),
          SwitchListTile(
            ...
            onChanged: (value) {
              // TODO(developer): Сохранить настройку
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(content: Text('Email-уведомления ${value ? 'включены' : 'отключены'}')),
              );
            },
          ),
          const Divider(),
  ...
  Widget _buildLanguageSection(BuildContext context) => Card(
    child: Padding(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Text('Язык', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
          const SizedBox(height: 16),
          ListTile(
            ...
            onTap: () {
              ...
              ScaffoldMessenger.of(
                context,
              ).showSnackBar(const SnackBar(content: Text('Язык изменен на русский')));
            },
          ),
          const Divider(),
          ListTile(
            ...
            onTap: () {
              ...
              ScaffoldMessenger.of(
                context,
              ).showSnackBar(const SnackBar(content: Text('Язык изменен на английский')));
            },
          ),
        ],
      ),
  ...
  Widget _buildThemeSection(BuildContext context) => const Card(
    child: Padding(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text('Тема приложения', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
          SizedBox(height: 16),
        ...
        children: [
          ...
          ListTile(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute<void>(builder: (context) => const AdminPanelScreen()),
              );
            },
          ),
          const Divider(),
          ListTile(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute<void>(builder: (context) => const AdminAnalyticsScreen()),
              );
            },
          ),
        ],
  ...
  Widget _buildAdditionalSettingsSection(BuildContext context) => Card(
    child: Padding(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Text('Дополнительно', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
          const SizedBox(height: 16),
          ListTile(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute<void>(builder: (context) => const UserReportsScreen()),
              );
            },
          ),
          const Divider(),
  ...
  Widget _buildLogoutSection(BuildContext context, WidgetRef ref) => Card(
    child: Padding(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Text('Аккаунт', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
          const SizedBox(height: 16),
          ListTile(
