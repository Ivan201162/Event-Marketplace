    ...
    builder: (context, snapshot) {
      ...
      return ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return FAQWidget(faqItem: faqItem, onTap: () => _showFAQDetail(faqItem));
        },
      );
    },
  );
  ...
  Widget _buildEmptyState() => const Center(
    child: Column(
      ...
      children: [
        ...
        SizedBox(height: 16),
        Text('Нет вопросов', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
        SizedBox(height: 8),
        Text(
...
class FAQDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Scaffold(
    appBar: AppBar(
      ...
      actions: [IconButton(icon: const Icon(Icons.share), onPressed: () => _shareFAQ(context))],
    ),
    body: SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          // Вопрос
          Text(faqItem.question, style: const TextStyle(fontSize: 24, fontWeight: FontWeight.bold)),

          const SizedBox(height: 16),

          // Ответ
          Text(faqItem.answer, style: const TextStyle(fontSize: 16, height: 1.6)),
  ...
  void _shareFAQ(BuildContext context) {
    ...
    ScaffoldMessenger.of(
      context,
    ).showSnackBar(const SnackBar(content: Text('FAQ скопирован в буфер обмена')));
  }
