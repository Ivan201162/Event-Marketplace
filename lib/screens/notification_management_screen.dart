...
class _NotificationManagementScreenState extends ConsumerState<NotificationManagementScreen> {
  ...
  Widget _buildTabs() => ResponsiveCard(
    child: Row(
      children: [
        ...
        Expanded(child: _buildTabButton('notifications', 'Отправленные', Icons.notifications)),
  ...
  Widget _buildTemplatesTab() => Column(
    children: [
      ...
      ResponsiveCard(
        child: Row(
          children: [
            Text('Шаблоны уведомлений', style: Theme.of(context).textTheme.titleMedium),
            const Spacer(),
            ElevatedButton.icon(
  ...
  Widget _buildNotificationsTab() => Column(
    children: [
      ...
      ResponsiveCard(
        child: Row(
          children: [
            Text('Отправленные уведомления', style: Theme.of(context).textTheme.titleMedium),
            const Spacer(),
            ElevatedButton.icon(
  ...
  Future<void> _loadNotifications() async {
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Ошибка загрузки уведомлений: $e'), backgroundColor: Colors.red),
      );
    }
  }
  ...
  void _addTemplate() {
    ...
    ScaffoldMessenger.of(
      context,
    ).showSnackBar(const SnackBar(content: Text('Функция добавления шаблона будет реализована')));
  }
