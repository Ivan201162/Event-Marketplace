...
class LocalizationMainScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) => Scaffold(
    appBar: AppBar(title: const Text('Локализация')),
    body: ListView(
      ...
      children: [
        ...
        // Статистика
        _buildSection(title: 'Статистика локализации', children: [_buildStatsCard()]),
  ...
  Widget _buildInfoCard() => Card(
    child: Padding(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Text('О локализации', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
          const SizedBox(height: 16),
          const Text(
          ...
          const SizedBox(height: 16),
          const Text('Функции:', style: TextStyle(fontSize: 14, fontWeight: FontWeight.w500)),
          const SizedBox(height: 8),
          const Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(content: Text('Переводы обновлены'), backgroundColor: Colors.green),
              );
            },
