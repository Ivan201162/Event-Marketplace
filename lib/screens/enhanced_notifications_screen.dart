...
class _EnhancedNotificationsScreenState extends ConsumerState<EnhancedNotificationsScreen>
  ...
  Widget build(BuildContext context) => Scaffold(
    appBar: AppBar(
      ...
      actions: [
        IconButton(onPressed: _showFiltersDialog, icon: const Icon(Icons.filter_list)),
        IconButton(onPressed: _showMarkAllReadDialog, icon: const Icon(Icons.mark_email_read)),
      ],
      bottom: TabBar(
  ...
  Widget _buildEmptyState() => Center(
    child: Column(
      ...
      children: [
        ...
        Text('Нет уведомлений', style: TextStyle(fontSize: 18, color: Colors.grey[600])),
  ...
  Widget _buildEmptyUnreadState() => Center(
    child: Column(
      ...
      children: [
        ...
        const SizedBox(height: 16),
        Text('Все уведомления прочитаны', style: TextStyle(fontSize: 18, color: Colors.grey[600])),
        const SizedBox(height: 8),
        Text(
  ...
  Widget _buildEmptyArchivedState() => Center(
    child: Column(
      ...
      children: [
        ...
        const SizedBox(height: 16),
        Text('Архив пуст', style: TextStyle(fontSize: 18, color: Colors.grey[600])),
        const SizedBox(height: 8),
        Text(
  ...
  Widget _buildLoginPrompt() => Center(
    child: Column(
      ...
      children: [
        ...
        const SizedBox(height: 16),
        Text('Войдите в аккаунт', style: TextStyle(fontSize: 18, color: Colors.grey[600])),
        const SizedBox(height: 8),
        Text(
  ...
  Widget _buildErrorState(String error) => Center(
    child: Column(
      ...
      children: [
        ...
        const SizedBox(height: 16),
        Text('Ошибка загрузки', style: TextStyle(fontSize: 18, color: Colors.red[600])),
        const SizedBox(height: 8),
        Text(
          error,
          textAlign: TextAlign.center,
          ...
          content: Column(
            ...
            children: [
              DropdownButtonFormField<NotificationType?>(
                ...
                items: [
                  const DropdownMenuItem(child: Text('Все типы')),
    ...
    notificationsService
        ...
        .catchError((error) {
          ScaffoldMessenger.of(
            context,
          ).showSnackBar(SnackBar(content: Text('Ошибка: $error'), backgroundColor: Colors.red));
        });
  }
            ...
            onPressed: () {
              ...
              notificationsService
                  ...
                  .then((_) {
                    ...
                    ScaffoldMessenger.of(
                      context,
                    ).showSnackBar(const SnackBar(content: Text('Все уведомления удалены')));
                  })
                  .catchError((error) {
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(content: Text('Ошибка: $error'), backgroundColor: Colors.red),
  ...
  void _applyFilters() {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(content: Text('Фильтры применены'), duration: Duration(seconds: 2)),
    );
  }
}
