...
class SimpleReviewsScreen extends ConsumerStatefulWidget {
  const SimpleReviewsScreen({super.key, required this.specialistId, required this.specialistName});
...
class _SimpleReviewsScreenState extends ConsumerState<SimpleReviewsScreen> {
  ...
  Widget build(BuildContext context) => Scaffold(
    appBar: AppBar(
      ...
      actions: [
        IconButton(icon: const Icon(Icons.add), onPressed: _addReview, tooltip: 'Добавить отзыв'),
      ],
    ),
    body: _buildBody(),
  );
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            Text('Пока нет отзывов', style: TextStyle(fontSize: 18, color: Colors.grey.shade600)),
            const SizedBox(height: 8),
            Text(
        ...
        children: [
          ...
          Row(
            children: [
              ...
              // Ответы
              IconButton(
                icon: Icon(Icons.reply, color: Colors.grey.shade600),
                onPressed: () {
                    ...
                    .map(
                      (response) => Column(
                        ...
                        children: [
                          ...
                          Text(response.text, style: const TextStyle(fontSize: 12)),
