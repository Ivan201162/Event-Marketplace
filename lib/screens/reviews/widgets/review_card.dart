...
class ReviewCard extends StatefulWidget {
  const ReviewCard({super.key, required this.review, this.onLike, this.onReport});
  final Review review;
      ...
      PopupMenuButton<String>(
        ...
        itemBuilder: (context) => [
          const PopupMenuItem(
            value: 'report',
            child: Row(
              children: [Icon(Icons.flag, size: 16), SizedBox(width: 8), Text('Пожаловаться')],
            ),
          ),
        ],
      ),
      ...
      InkWell(
        ...
        child: Row(
          ...
          children: [
            ...
            const SizedBox(width: 4),
            Text(widget.review.likes.toString(), style: Theme.of(context).textTheme.bodySmall),
          ],
        ),
      ),
        ...
        InkWell(
          ...
          child: Row(
            ...
            children: [
              ...
              const SizedBox(width: 4),
              Text(
                '${widget.review.responses.length} ответ${widget.review.responses.length == 1
                    ? ''
                    : widget.review.responses.length < 5
                    ? 'а'
                    : 'ов'}',
            ...
            (response) => Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(response.text, style: Theme.of(context).textTheme.bodySmall),
                ],
              ),
            ),
          ),
