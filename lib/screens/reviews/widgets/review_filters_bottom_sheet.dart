...
class ReviewFiltersBottomSheet extends StatefulWidget {
  const ReviewFiltersBottomSheet({super.key, this.currentFilter, required this.onFilterChanged});
  ...
  Widget build(BuildContext context) => Container(
    ...
    child: Column(
      ...
      children: [
        ...
        Row(
          children: [
            Expanded(child: Text('Фильтры отзывов', style: Theme.of(context).textTheme.titleLarge)),
        ...
        children: [
          ...
          Expanded(
            child: OutlinedButton.icon(
              ...
              icon: const Icon(Icons.calendar_today, size: 16),
              label: Text(
                _toDate != null ? '${_toDate!.day}.${_toDate!.month}.${_toDate!.year}' : 'По дату',
              ),
            ),
          ),
        ],
