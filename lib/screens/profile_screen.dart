...
class _ProfileScreenState extends ConsumerState<ProfileScreen>
  ...
  final Map<String, dynamic> _userProfile = {
    ...
    'bio': 'Профессиональный фотограф с 5-летним опытом. Специализируюсь на свадебной и портретной съёмке.',
    'rating': 4.8,
    'reviewsCount': 127,
    'isVerified': true,
  ...
  final List<Map<String, dynamic>> _reviews = [
    {
      ...
      'rating': 5,
      'text': 'Отличная работа! Александр очень профессионально подошёл к съёмке нашей свадьбы. Все фотографии получились просто потрясающими!',
      'date': '1 неделю назад',
    },
    {
      'id': '2',
      ...
      'rating': 5,
      'text': 'Рекомендую! Очень качественная работа, быстрое выполнение заказа. Фотографии превзошли все ожидания.',
      'date': '2 недели назад',
    },
    {
      'id': '3',
      ...
      'rating': 4,
      'text': 'Хороший фотограф, но немного задержал с готовностью фотографий. В целом результатом довольна.',
      'date': '3 недели назад',
    },
  ];
  ...
  Widget _buildProfileContent(user, theme) {
    return Scaffold(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildInfoRow(Icons.location_on, 'Местоположение', _userProfile['location']),
            _buildInfoRow(Icons.work, 'Опыт работы', _userProfile['experience']),
            _buildInfoRow(Icons.attach_money, 'Стоимость', '${_userProfile['pricePerHour']}₽/час'),
                  ...
                  child: Column(
                    children: [
                                ...
                                child: IconButton(
                                  ...
                                  onPressed: () {
                                    ...
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      const SnackBar(
                                        content: Text('Функция смены фото будет добавлена'),
                                      ),
                                    );
                                  },
                                ),
                      ...
                      TextField(
                        ...
                        controller: TextEditingController(text: '+7 (999) 123-45-67'),
