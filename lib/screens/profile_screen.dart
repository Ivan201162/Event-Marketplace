...
class ProfileScreen extends ConsumerWidget {
      ...
      data: (profile) {
        ...
        return Column(
          ...
          children: [
            ...
            const SizedBox(height: 8),
            Text(
              'Почасовая ставка: ${profile.hourlyRate.toStringAsFixed(0)} ₽',
              style: Theme.of(context)
                  .textTheme
                  .bodyMedium
                  ?.copyWith(fontWeight: FontWeight.w500),
              ...
              if (user.role == UserRole.customer) ...[
                ...
                ListTile(
                  ...
                  onTap: () => Navigator.of(context).push(
                    MaterialPageRoute(
                      builder: (context) =>
                          CustomerNotesScreen(userId: user.id),
                    ),
                  ),
                ),
              ],
  ...
  Widget _buildTestDataCard(BuildContext context, WidgetRef ref) => Card(
        elevation: 4,
        child: Padding(
          padding: const EdgeInsets.all(20),
          child: Column(
