  ...
  Widget _buildQuickFilters() => Wrap(
    ...
    children: [
      _buildFilterChip(
        ...
        onTap: () =>
            _applyFilters(const filters.SpecialistFilters(minPrice: 5000, maxPrice: 10000)),
      ),
      _buildFilterChip(
        label: 'Рейтинг: 4.5+',
        isSelected: _currentFilters.minRating == 4.5,
        onTap: () => _applyFilters(const filters.SpecialistFilters(minRating: 4.5)),
      ),
      _buildFilterChip(
        label: 'Москва',
        isSelected: _currentFilters.city == 'Москва',
        onTap: () => _applyFilters(const filters.SpecialistFilters(city: 'Москва')),
      ),
      _buildFilterChip(
        label: 'Верифицированные',
        isSelected: _currentFilters.isVerified ?? false,
        onTap: () => _applyFilters(const filters.SpecialistFilters(isVerified: true)),
      ),
      _buildFilterChip(
        label: 'Доступные',
        isSelected: _currentFilters.isAvailable ?? false,
        onTap: () => _applyFilters(const filters.SpecialistFilters(isAvailable: true)),
      ),
      _buildFilterChip(
        label: 'По цене ↑',
        isSelected:
      ...
      _buildFilterChip(
        ...
        isSelected:
            ...
            !_currentFilters.sortAscending,
        onTap: () => _applyFilters(
          const filters.SpecialistFilters(sortBy: filters.SpecialistSortOption.rating),
        ),
      ),
      _buildFilterChip(
        label: 'Сбросить',
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              Text('${specialist.rating} (${specialist.reviewCount})'),
                            ],
                          ),
                        ],
                      ),
                  ...
                  Text(specialist.bio, maxLines: 2, overflow: TextOverflow.ellipsis),
                  const SizedBox(height: 8),
                  Row(
                    children: [
