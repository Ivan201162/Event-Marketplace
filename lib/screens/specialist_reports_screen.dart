...
class _SpecialistReportsScreenState extends ConsumerState<SpecialistReportsScreen>
        ...
        return Center(
          child: Column(
            ...
            children: [
              ...
              Text('Ошибка загрузки отчета', style: Theme.of(context).textTheme.titleLarge),
    ...
    builder: (context, snapshot) {
      ...
      return SingleChildScrollView(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            _buildReportHeader('Статистика по категориям', report.generatedAt),
            const SizedBox(height: 24),
    ...
    builder: (context, snapshot) {
      ...
      return SingleChildScrollView(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            _buildReportHeader('Статистика по рейтингам', report.generatedAt),
            const SizedBox(height: 24),
    ...
    builder: (context, snapshot) {
      ...
      return SingleChildScrollView(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            _buildReportHeader('Статистика по активности', report.generatedAt),
            const SizedBox(height: 24),
  ...
  Widget _buildMetricsGrid(SpecialistReport report) => GridView.count(
    ...
    children: [
      ...
      _buildMetricCard('Категорий', report.totalCategories.toString(), Icons.category, Colors.teal),
    ],
  );
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: const Center(child: Text('Диаграмма распределения')),
          ),
        ],
      ),
    ),
        ...
        children: [
          ...
          Row(
            children: [
              ...
              Expanded(
                child: _buildStatItem('Отзывов', stats.totalReviews.toString(), Icons.reviews),
              ),
            ],
          ),
        ],
                    ...
                    children: [
                      CircleAvatar(
                        ...
                        child: specialist.photoURL == null
                            ? Text(specialist.name?.substring(0, 1).toUpperCase() ?? '?')
                            : null,
                      ),
  ...
  Widget _buildTopEarnersCard(List<MapEntry<SpecialistProfile, double>> topEarners) => Card(
    child: Padding(
      padding: const EdgeInsets.all(16),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
