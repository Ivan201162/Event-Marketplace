...
class _CacheManagementScreenState extends ConsumerState<CacheManagementScreen> {
    ...
    return ResponsiveCard(
      child: Row(
        children: [
          ...
          Expanded(
            child: _buildTabButton('items', 'Элементы', Icons.list),
          ),
          Expanded(
  ...
  Widget _buildCacheItemCard(String key) {
                ...
                children: [
                  ...
                  _buildConfigSection(
                    ...
                    [
                      ...
                      _buildConfigItem('Максимальный размер',
                ...
                if (_statistics == null)
                  ...
                  Column(
                    children: [
                      ...
                      _buildStatRow('Среднее время до истечения',
