      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            child: Icon(Icons.event, size: 60, color: Theme.of(context).colorScheme.onPrimary),
          ),
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 12),
                  _buildInfoRow(context, 'Разработчик', 'Event Marketplace Team'),
                  _buildInfoRow(context, 'Email', 'support@eventmarketplace.com'),
                  _buildInfoRow(context, 'Веб-сайт', 'www.eventmarketplace.com'),
