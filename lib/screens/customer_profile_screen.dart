...
class _CustomerProfileScreenState extends ConsumerState<CustomerProfileScreen>
  ...
  void _toggleFollow(UserProfile profile) {
    ...
    ScaffoldMessenger.of(context)
        .showSnackBar(const SnackBar(content: Text('Подписка/отписка')));
  }
  ...
  void _openHelp() {
    ...
    ScaffoldMessenger.of(context)
        .showSnackBar(const SnackBar(content: Text('Справка')));
  }

  void _openAbout() {
    // TODO(developer): Открыть информацию о приложении
    ScaffoldMessenger.of(context)
        .showSnackBar(const SnackBar(content: Text('О приложении')));
  }
