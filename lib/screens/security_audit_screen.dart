...
class _SecurityAuditScreenState extends ConsumerState<SecurityAuditScreen> {
                ...
                child: DropdownButtonFormField<SecurityEventType?>(
                  ...
                  items: [
                    ...
                    ...SecurityEventType.values.map((type) {
                      return DropdownMenuItem<SecurityEventType?>(
                        value: type,
              ...
              Expanded(
                child: DropdownButtonFormField<SecurityEventSeverity?>(
                  ...
                  items: [
                    ...
                    ...SecurityEventSeverity.values.map((severity) {
                      return DropdownMenuItem<SecurityEventSeverity?>(
                        value: severity,
  ...
  Widget _buildEventItem(SecurityAuditLog event) {
    return Card(
