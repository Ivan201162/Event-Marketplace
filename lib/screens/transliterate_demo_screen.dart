    ...
    body: SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          Card(
            child: Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('Генератор username', style: Theme.of(context).textTheme.headlineSmall),
                  ...
                  if (_generatedUsername.isNotEmpty) ...[
                    ...
                    Container(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('Результат:', style: Theme.of(context).textTheme.titleSmall),
          ...
          Text('Примеры транслитерации:', style: Theme.of(context).textTheme.headlineSmall),
          const SizedBox(height: 16),
          ..._examples.map(
            (example) => Card(
