...
class _TransactionsScreenState extends ConsumerState<TransactionsScreen>
  ...
  Widget _buildIncomeTransactionsTab(String userId) {
    final incomeTransactionsAsync =
        ref.watch(incomeTransactionsProvider(userId));
  ...
  Widget _buildExpenseTransactionsTab(String userId) {
    final expenseTransactionsAsync =
        ref.watch(expenseTransactionsProvider(userId));
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    if (transaction.notes != null)
                      _buildDetailRow('Заметки', transaction.notes!),
