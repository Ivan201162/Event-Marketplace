        ...
        children: [
          Row(
            children: [
              ...
              const SizedBox(width: 8),
              const Text('Заказчик', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
            ],
          ),
          const SizedBox(height: 16),
          _InfoRow(
        ...
        children: [
          Row(
            children: [
              ...
              const SizedBox(width: 8),
              const Text('Специалист', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
            ],
          ),
          const SizedBox(height: 16),
          _InfoRow(
        ...
        children: [
          Row(
            children: [
              ...
              const SizedBox(width: 8),
              const Text('Платеж', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
            ],
          ),
          const SizedBox(height: 16),
          _InfoRow(
