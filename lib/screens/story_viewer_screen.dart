  ...
  Widget build(BuildContext context) {
    if (widget.stories.isEmpty) {
      return const Scaffold(
        ...
        body: Center(
          child: Text('Нет сторис для просмотра', style: TextStyle(color: Colors.white)),
        ),
      );
    }
  ...
  Widget _buildMainContent(SpecialistStory story) {
    switch (story.contentType) {
      ...
      case StoryContentType.video:
        ...
        return const Center(
          child: Text('Видео плеер будет реализован', style: TextStyle(color: Colors.white)),
        );
    ...
    children: [
      ...
      Expanded(
        child: GestureDetector(
          ...
          child: Container(height: double.infinity, color: Colors.transparent),
        ),
      ),
