...
import '../providers/smart_search_providers.dart';
              ...
              child: Container(
                ...
                child: Center(
                  child: CircleAvatar(
                    ...
                    backgroundColor: Theme.of(context).primaryColor,
                    child: Text(
                                  (specialist['name'] as String?)?.isNotEmpty == true
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 4),
                    Text(
                                  (specialist['category'] as String?) ?? 'Специалист',
                    ...
                    Row(
                      children: [
                        ...
                        const SizedBox(width: 4),
                        Text(
                                      ((specialist['rating'] as num?) ?? 0.0).toStringAsFixed(1),
                          style: Theme.of(context).textTheme.bodySmall,
                        ),
                        const Spacer(),
                        Text(
