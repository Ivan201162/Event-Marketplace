...
class _EventsCatalogScreenState extends ConsumerState<EventsCatalogScreen> {
  ...
  Widget _buildPriceFilter() => Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
      const Text('Цена', style: TextStyle(fontWeight: FontWeight.w500)),
      const SizedBox(height: 8),
      Row(
        children: [
          Expanded(
  ...
  Widget _buildDateFilter() => Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
      const Text('Дата', style: TextStyle(fontWeight: FontWeight.w500)),
      const SizedBox(height: 8),
      Row(
        children: [
          Expanded(
        ...
        child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return Padding(
              ...
              child: EventCard(event: event, onTap: () => _navigateToEventDetail(event)),
            );
          },
        ),
      );
  ...
  void _performSearch() {
    ...
    setState(() {
      _currentFilter = _currentFilter.copyWith(searchQuery: query.isEmpty ? null : query);
    });
  }
  ...
  void _navigateToEventDetail(Event event) {
    Navigator.of(
      context,
    ).push(MaterialPageRoute<void>(builder: (context) => EventDetailScreen(event: event)));
  }
}
