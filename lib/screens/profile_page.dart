...
class _ProfilePageState extends ConsumerState<ProfilePage> {
  ...
  Widget build(BuildContext context) => AuthGuard(
    child: UserInfoWidget(
      ...
      fallbackWidget: const Scaffold(body: Center(child: Text('Пользователь не авторизован'))),
    ),
  );
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(color: _getRoleColor(appUser.role).withValues(alpha: 0.3)),
                  ),
                  child: Text(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildInfoRow('Дата регистрации', _formatDate(appUser.createdAt)),
                        if (appUser.lastLoginAt != null)
                          _buildInfoRow('Последний вход', _formatDate(appUser.lastLoginAt!)),
                        _buildInfoRow('Статус', appUser.isActive ? 'Активен' : 'Заблокирован'),
  ...
  void _navigateToEditProfile() {
    Navigator.push(
      context,
      MaterialPageRoute<void>(builder: (context) => const ProfileEditScreen()),
    );
  }
}
