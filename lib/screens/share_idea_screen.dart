...
class _ShareIdeaScreenState extends ConsumerState<ShareIdeaScreen> {
  ...
  Widget _buildChatItem(String chatId, String otherParticipantId, Map<String, dynamic> chat) => FutureBuilder<DocumentSnapshot>(
  ...
  Future<void> _shareToChat(String chatId, String otherParticipantId, String otherParticipantName) async {
