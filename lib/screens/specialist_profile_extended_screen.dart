...
class SpecialistProfileExtendedScreen extends ConsumerStatefulWidget {
  const SpecialistProfileExtendedScreen({super.key, required this.specialistId});
...
class _SpecialistProfileExtendedScreenState extends ConsumerState<SpecialistProfileExtendedScreen>
  ...
  Future<void> _addPortfolioItem() async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(content: Text('Добавление работы в портфолио будет реализовано')),
    );
  }
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  const Text('за час', style: TextStyle(fontSize: 14, color: Colors.grey)),
                ],
              ),
            ],
          ),
  ...
  Widget _buildTabContent() => TabBarView(
    controller: _tabController,
    children: [_buildPortfolioTab(), _buildReviewsTab(), _buildPriceListTab(), _buildCalendarTab()],
  );
    ...
    child: Column(
      ...
      children: [
        Row(
          ...
          children: [
            const Text('Портфолио', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
          ...
          const Center(
            child: Column(
              children: [
                ...
                SizedBox(height: 16),
                Text('Отзывов пока нет', style: TextStyle(color: Colors.grey, fontSize: 16)),
                SizedBox(height: 8),
                Text(
  ...
  Widget _buildPriceListTab() => SingleChildScrollView(
    ...
    child: Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        const Text('Прайс-лист', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
        const SizedBox(height: 16),
        PriceListWidget(
