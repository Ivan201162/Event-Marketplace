...
class _EnhancedSettingsScreenState extends ConsumerState<EnhancedSettingsScreen>
  ...
  final List<LanguageOption> _languages = [
    ...
    LanguageOption(code: 'kk', name: 'Қазақша', flag: '🇰🇿'),
  ];

  final List<ThemeOption> _themes = [
    ThemeOption(code: 'light', name: 'Светлая', icon: Icons.light_mode),
    ThemeOption(code: 'dark', name: 'Тёмная', icon: Icons.dark_mode),
    ThemeOption(code: 'system', name: 'Системная', icon: Icons.brightness_auto),
  ];
      ...
      builder: (context) => AlertDialog(
        ...
        content: SizedBox(
          ...
          child: CreateAdvertisementWidget(
            advertiserId: 'current_user_id', // TODO: Получить реальный ID пользователя
            onCreated: () {
              Navigator.pop(context);
