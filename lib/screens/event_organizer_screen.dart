...
class _EventOrganizerScreenState extends ConsumerState<EventOrganizerScreen> {
  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      final topOrganizers = await _organizerService.getTopOrganizers(limit: 10);
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (_topOrganizers.isEmpty)
                    ...
                    ..._topOrganizers.map((organizer) => 
                        _buildOrganizerCard(organizer)),
  ...
  Widget _buildOrganizerCard(EventOrganizer organizer) {
    return Card(
          ...
          children: [
            ...
            if (organizer.eventTypes.isNotEmpty) ...[
              ...
              Wrap(
                spacing: 4,
                runSpacing: 4,
                children: organizer.eventTypes.take(3).map((type) =>
                  Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Wrap(
                      spacing: 8,
                      runSpacing: 8,
                      children: organizer.specializations.map((spec) =>
                        Chip(
                          label: Text(spec),
