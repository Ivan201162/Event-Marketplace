...
class _EventOrganizerScreenState extends ConsumerState<EventOrganizerScreen> {
  ...
  Future<void> _createOrganizerProfile() async {
    final result = await Navigator.of(
      context,
    ).push(MaterialPageRoute(builder: (context) => const CreateOrganizerProfileScreen()));
    ...
    child: Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              ...
              CircleAvatar(
                ...
                child: Text(
                  organizer.companyName.isNotEmpty ? organizer.companyName[0].toUpperCase() : 'О',
                  style: TextStyle(
              ...
              children: organizer.eventTypes
                  ...
                  .map(
                    (type) => Container(
                      ...
                      child: Text(type, style: TextStyle(color: Colors.purple[700], fontSize: 10)),
                    ),
                  )
                  .toList(),
            ),
          ...
          Row(
            children: [
              _buildStatItem('Мероприятий', '${organizer.totalEvents}', Icons.event),
              const SizedBox(width: 16),
              _buildStatItem('Завершено', '${organizer.completedEvents}', Icons.check_circle),
              const Spacer(),
  ...
  void _viewOrganizerDetails(EventOrganizer organizer) {
    Navigator.of(
      context,
    ).push(MaterialPageRoute(builder: (context) => OrganizerDetailsScreen(organizer: organizer)));
  }
}
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      child: const Text('Создать профиль', style: TextStyle(fontSize: 16)),
                    ),
                  ),
                ],
              ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Wrap(
                    ...
                    runSpacing: 8,
                    children: organizer.eventTypes
                        .map((type) => Chip(label: Text(type), backgroundColor: Colors.purple[50]))
                        .toList(),
                  ),
                ],
              ),
                ...
                children: [
                  ...
                  Wrap(
                    ...
                    children: organizer.specializations
                        .map((spec) => Chip(label: Text(spec), backgroundColor: Colors.blue[50]))
                        .toList(),
                  ),
                ],
              ),
