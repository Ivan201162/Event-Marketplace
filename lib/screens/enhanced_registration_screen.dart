    ...
    body: ResponsiveContainer(
      child: Row(
        children: [
          ...
          SizedBox(
            width: 300,
            child: Column(children: [const SizedBox(height: 20), _buildHelpPanel()]),
          ),
        ],
      ),
    ),
    ...
    child: Column(
      children: [
        Row(
          ...
          children: [
            ResponsiveText('Шаг ${_currentPage + 1} из $_totalPages', isSubtitle: true),
            ResponsiveText(
      ...
      children: [
        ...
        Expanded(
          child: ElevatedButton(
            ...
            child: Text(_currentPage == _totalPages - 1 ? 'Завершить' : 'Далее'),
          ),
        ),
      ],
    ),
