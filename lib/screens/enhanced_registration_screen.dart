...
class _EnhancedRegistrationScreenState
      ...
      child: Column(
        children: [
          Row(
            ...
            children: [
              ResponsiveText(
                'Шаг ${_currentPage + 1} из $_totalPages',
                isSubtitle: true,
              ),
              ResponsiveText(
            ...
            return ListTile(
              leading: CircleAvatar(
                ...
                child: Text(
                  ...
                  style: TextStyle(
                    color:
                        index <= _currentPage ? Colors.white : Colors.grey[600],
                    fontSize: 12,
        ...
        children: [
          ...
          Expanded(
            child: ElevatedButton(
              ...
              child:
                  Text(_currentPage == _totalPages - 1 ? 'Завершить' : 'Далее'),
            ),
          ),
        ],
      ),
  ...
  bool _isBusinessUser() {
    return _selectedUserType == UserType.individualEntrepreneur ||
        _selectedUserType == UserType.selfEmployed ||
        _selectedUserType == UserType.organization;
  }

  bool _isSpecialistUser() {
    return _selectedUserType == UserType.specialist ||
