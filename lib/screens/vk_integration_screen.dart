...
class _VKIntegrationScreenState extends ConsumerState<VKIntegrationScreen>
      ...
      return const Center(
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 16),
            Text(
              'Профиль VK не загружен',
              style: TextStyle(fontSize: 18, color: Colors.grey),
            ),
            SizedBox(height: 8),
            Text(
              'Сначала подключите VK профиль',
  ...
  Widget _buildPostCard(String postText, int index) {
    return Card(
