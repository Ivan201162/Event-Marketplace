...
class Event {
  const Event({
    ...
    required this.date,
    required this.location, required this.price, required this.organizerId, required this.organizerName, required this.category, required this.status, required this.createdAt, required this.updatedAt, this.endDate,
    this.organizerPhoto,
  ...
  factory Event.fromDocument(DocumentSnapshot doc) {
    ...
    return Event(
      ...
      organizerPhoto: data['organizerPhoto'] as String?,
      ...
      maxParticipants: data['maxParticipants'] as int? ?? 50,
      ...
      additionalInfo: Map<String, dynamic>.from(
        (data['additionalInfo'] as Map<dynamic, dynamic>?) ?? {},
      ),
