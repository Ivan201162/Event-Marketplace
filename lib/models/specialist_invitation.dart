...
class SpecialistInvitation {
  ...
  @override
  String toString() {
    return 'SpecialistInvitation(id: $id, orderId: $orderId, specialistId: $specialistId, status: $status)';
  }
...
class InvitationStats {
  ...
  factory InvitationStats.fromMap(Map<String, dynamic> map) {
