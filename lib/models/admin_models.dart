...
class MarketingCampaign {
  ...
  factory MarketingCampaign.fromMap(Map<String, dynamic> map) {
    return MarketingCampaign(
      ...
      name: map['name'] ?? '',
      description: map['description'] ?? '',
      type: MarketingCampaignType.values.byName(map['type'] ?? MarketingCampaignType.promotion.name),
      status: MarketingCampaignStatus.values.byName(map['status'] ?? MarketingCampaignStatus.draft.name),
