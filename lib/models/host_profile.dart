  ...
  factory HostProfile.fromFirestore(DocumentSnapshot doc) {
    ...
    return HostProfile(
      ...
      priceRange: PriceRange.fromMap(
        Map<String, dynamic>.from((data['priceRange'] as Map<dynamic, dynamic>?) ?? {}),
      ),
      ...
      reviews:
          ...
          [],
      availableDates:
          (data['availableDates'] as List<dynamic>?)
...
class PriceRange {
  const PriceRange({required this.minPrice, required this.maxPrice, this.currency = 'RUB'});
