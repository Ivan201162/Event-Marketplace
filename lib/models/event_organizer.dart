...
class EventOrganizer {
  const EventOrganizer({
    ...
    required this.eventTypes, required this.specializations, required this.totalEvents, required this.completedEvents, required this.createdAt, required this.updatedAt, required this.isVerified, required this.isActive, this.description,
    this.website,
    this.phone,
    this.email,
    this.address,
