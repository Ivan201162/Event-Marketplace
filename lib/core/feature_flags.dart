...
class FeatureFlags {
  ...
  // Безопасность
  static const bool enableMockFallbacks = true; // Показывать fallback при ошибках реальных данных
  static const bool enableDataValidation = true; // Валидация данных перед отображением
}