...
List<T> safeListFromDynamic<T>(List<dynamic>? data, T Function(dynamic) converter) {
...
T safeEnumFromString<T extends Enum>(List<T> values, dynamic data, T defaultValue) {
  if (data == null) return defaultValue;
