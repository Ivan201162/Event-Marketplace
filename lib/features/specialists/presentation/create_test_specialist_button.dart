...
class CreateTestSpecialistButton extends ConsumerStatefulWidget {
  const CreateTestSpecialistButton({super.key, this.onSpecialistCreated, this.specialistType});
...
class _CreateTestSpecialistButtonState extends ConsumerState<CreateTestSpecialistButton> {
    ...
    children: [
      ...
      SizedBox(
        ...
        child: ElevatedButton.icon(
          ...
          label: Text(_isCreating ? 'Создание...' : 'Создать тест-специалиста'),
  ...
  /// Создание фотографа
  Specialist _createPhotographer(String specialistId, String userId, DateTime now) => Specialist(
    id: specialistId,
    userId: userId,
    name: 'Анна Фотограф',
    description:
  ...
  /// Создание видеографа
  Specialist _createVideographer(String specialistId, String userId, DateTime now) => Specialist(
    id: specialistId,
    userId: userId,
    ...
    pricePerHour: 4000,
    description: 'Креативный видеограф и монтажер. Создаю запоминающиеся видео для любых событий.',
    bio: '5 лет в индустрии видео. Работаю с современным оборудованием и программным обеспечением.',
  ...
  Specialist _createDefaultSpecialist(
    ...
    createdAt: now,
    updatedAt: now,
    contacts: const {'Телефон': '+7 (999) 000-00-00', 'Email': 'test@example.com'},
