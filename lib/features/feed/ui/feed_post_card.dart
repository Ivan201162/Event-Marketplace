...
class FeedPostCard extends ConsumerWidget {
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Text(post.authorCity, style: TextStyle(color: Colors.grey[600], fontSize: 14)),
  ...
  Widget _buildPostActions(BuildContext context, bool isLiked) => Padding(
    ...
    child: Row(
      children: [
        ...
        // Комментарии
        _buildActionButton(icon: Icons.chat_bubble_outline, onTap: onComment),

        const SizedBox(width: 16),

        // Шаринг
        _buildActionButton(icon: Icons.share, onTap: onShare),
  ...
  void _hidePost(BuildContext context) {
    ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Пост скрыт')));
  }
}
