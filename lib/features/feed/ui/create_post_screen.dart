...
class _CreatePostScreenState extends ConsumerState<CreatePostScreen> {
  ...
  Future<void> _publishPost() async {
    if (_selectedType == null) {
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(const SnackBar(content: Text('Выберите тип поста')));
      return;
    }
    ...
    if (_selectedFile == null) {
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(const SnackBar(content: Text('Выберите медиа файл')));
      return;
    }
    ...
    if (_descriptionController.text.trim().isEmpty) {
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(const SnackBar(content: Text('Введите описание поста')));
      return;
    }
