    ...
    routes: [
      ...
      GoRoute(
        ...
        pageBuilder: (context, state) => CustomTransitionPage(
          ...
          transitionsBuilder: (context, animation, secondaryAnimation, child) => AnimatedPageTransitions.fadeScaleTransition(
              child: child,
              animation: animation,
...
class NavigationUtils {
  ...
  static Future<T?> showAnimatedDialog<T>(
    ...
    Duration duration = const Duration(milliseconds: 300),
      ...
      transitionBuilder: (context, animation, secondaryAnimation, child) => AnimatedPageTransitions.fadeScaleTransition(
          child: child,
          animation: animation,
          secondaryAnimation: secondaryAnimation,
        ),
