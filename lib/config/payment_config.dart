class PaymentConfig {
  ...
  static const Map<String, Map<String, dynamic>> promotionPackages = {
    'profile_boost_3days': {
      ...
      'features': ['Выделение в списке', 'Приоритет в поиске', 'Золотая рамка профиля'],
    },
    'profile_boost_week': {
    ...
    'post_boost_3days': {
      ...
      'durationDays': 3,
      'priorityLevel': 'medium',
      'features': ['Увеличение охвата', 'Приоритет в ленте', 'Аналитика просмотров'],
    },
    'post_boost_week': {
  ...
  static const Map<String, Map<String, dynamic>> advertisementRates = {
    'banner_top': {
      ...
      'minDuration': 1,
      'maxDuration': 30,
      'features': ['Высокая видимость', 'Таргетинг по региону', 'Аналитика показов'],
    },
    'banner_bottom': {
      'name': 'Нижний баннер',
      'type': 'banner',
      ...
      'minDuration': 1,
      'maxDuration': 30,
      'features': ['Хорошая видимость', 'Таргетинг по региону', 'Аналитика показов'],
    },
    'sponsored_post': {
      ...
      'minDuration': 1,
      'maxDuration': 7,
      'features': ['Органичный вид', 'Высокий CTR', 'Детальная аналитика', 'Таргетинг аудитории'],
    },
    'category_ad': {
      ...
      'minDuration': 1,
      'maxDuration': 30,
      'features': ['Таргетинг по категории', 'Аналитика кликов', 'Региональный таргетинг'],
    },
  };
