...
List<Idea> _getTestIdeas() => [
    Idea(
      ...
      description: 'Романтичная свадьба с элементами бохо-шика: натуральные материалы, пастельные тона, цветочные композиции',
...
final ideasNotifierProvider = StateNotifierProvider<IdeasNotifier, AsyncValue<List<Idea>>>((ref) => IdeasNotifier());
