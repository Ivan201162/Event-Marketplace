...
final specialistProposalServiceProvider =
    Provider<SpecialistProposalService>((ref) => SpecialistProposalService());
...
final customerProposalsProvider =
    StreamProvider.family<List<SpecialistProposal>, String>((ref, customerId) {
  final service = ref.read(specialistProposalServiceProvider);
...
final organizerProposalsProvider =
    StreamProvider.family<List<SpecialistProposal>, String>((ref, organizerId) {
  final service = ref.read(specialistProposalServiceProvider);
...
final proposalProvider =
    FutureProvider.family<SpecialistProposal?, String>((ref, proposalId) async {
  final service = ref.read(specialistProposalServiceProvider);
...
final acceptProposalProvider =
    FutureProvider.family<void, AcceptProposalParams>((ref, params) async {
  final service = ref.read(specialistProposalServiceProvider);
...
final organizerStatsProvider =
    FutureProvider.family<Map<String, int>, String>((ref, organizerId) async {
  final service = ref.read(specialistProposalServiceProvider);
