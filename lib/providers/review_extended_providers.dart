...
final specialistReviewsProvider = StreamProvider.family<List<ReviewExtended>, (String, ReviewFilter)>((ref, params) {
...
final specialistReviewStatsProvider = FutureProvider.family<SpecialistReviewStats, String>((ref, specialistId) {
  final service = ref.read(reviewExtendedServiceProvider);
...
final reviewsWithMediaProvider = StreamProvider.family<List<ReviewExtended>, String>((ref, specialistId) {
...
final verifiedReviewsProvider = StreamProvider.family<List<ReviewExtended>, String>((ref, specialistId) {
  final filter = const ReviewFilter(isVerified: true);
  return ref.watch(specialistReviewsProvider((specialistId, filter)));
});

/// Провайдер для отзывов по рейтингу
final reviewsByRatingProvider = StreamProvider.family<List<ReviewExtended>, (String, int)>((ref, params) {
...
final reviewsWithTagsProvider = StreamProvider.family<List<ReviewExtended>, (String, List<String>)>((ref, params) {
...
final recentReviewsProvider = StreamProvider.family<List<ReviewExtended>, (String, int)>((ref, params) {
...
final topReviewsByLikesProvider = StreamProvider.family<List<ReviewExtended>, (String, int)>((ref, params) {
  final (specialistId, limit) = params;
...
final highRatedReviewsProvider = StreamProvider.family<List<ReviewExtended>, String>((ref, specialistId) {
  final filter = const ReviewFilter(minRating: 4);
  return ref.watch(specialistReviewsProvider((specialistId, filter)));
});

/// Провайдер для отзывов с низким рейтингом
final lowRatedReviewsProvider = StreamProvider.family<List<ReviewExtended>, String>((ref, specialistId) {
  final filter = const ReviewFilter(maxRating: 2);
  return ref.watch(specialistReviewsProvider((specialistId, filter)));
});

/// Провайдер для поиска отзывов
final searchReviewsProvider = StreamProvider.family<List<ReviewExtended>, (String, String)>((ref, params) {
...
final reviewsForPeriodProvider = StreamProvider.family<List<ReviewExtended>, (String, DateTime, DateTime)>((ref, params) {
...
final reviewsLastMonthProvider = StreamProvider.family<List<ReviewExtended>, String>((ref, specialistId) {
...
final reviewsLastYearProvider = StreamProvider.family<List<ReviewExtended>, String>((ref, specialistId) {
  final now = DateTime.now();
...
final averageRatingProvider = StreamProvider.family<double, String>((ref, specialistId) {
...
final totalReviewsCountProvider = StreamProvider.family<int, String>((ref, specialistId) {
  return ref.watch(specialistReviewStatsProvider(specialistId)).when(
...
final totalLikesCountProvider = StreamProvider.family<int, String>((ref, specialistId) {
  return ref.watch(specialistReviewStatsProvider(specialistId)).when(
...
final ratingDistributionProvider = StreamProvider.family<Map<int, int>, String>((ref, specialistId) {
  return ref.watch(specialistReviewStatsProvider(specialistId)).when(
...
final topTagsProvider = StreamProvider.family<List<String>, String>((ref, specialistId) {
  return ref.watch(specialistReviewStatsProvider(specialistId)).when(
...
final categoryRatingsProvider = StreamProvider.family<Map<String, double>, String>((ref, specialistId) {
  return ref.watch(specialistReviewStatsProvider(specialistId)).when(
...
final reviewsWithDetailedRatingsProvider = StreamProvider.family<List<ReviewExtended>, String>((ref, specialistId) {
  return ref.watch(specialistReviewsProvider((specialistId, const ReviewFilter()))).when(
...
/// Провайдер для отзывов с медиа
final reviewsWithPhotosProvider = StreamProvider.family<List<ReviewExtended>, String>((ref, specialistId) {
  return ref.watch(specialistReviewsProvider((specialistId, const ReviewFilter()))).when(
    data: (reviews) => Stream.value(
...
final reviewsWithVideosProvider = StreamProvider.family<List<ReviewExtended>, String>((ref, specialistId) {
  return ref.watch(specialistReviewsProvider((specialistId, const ReviewFilter()))).when(
    data: (reviews) => Stream.value(
...
final reviewsWithLikesProvider = StreamProvider.family<List<ReviewExtended>, String>((ref, specialistId) {
  return ref.watch(specialistReviewsProvider((specialistId, const ReviewFilter()))).when(
    data: (reviews) => Stream.value(
...
final reviewsWithoutLikesProvider = StreamProvider.family<List<ReviewExtended>, String>((ref, specialistId) {
  return ref.watch(specialistReviewsProvider((specialistId, const ReviewFilter()))).when(
    data: (reviews) => Stream.value(
      reviews.where((review) => review.likesCount == 0).toList(),
    ),
