...
final userChatsProvider = FutureProvider.family<List<Chat>, String>((ref, userId) async {
...
final unreadMessagesCountStreamProvider = StreamProvider.family<int, String>((ref, userId) {
  final service = ref.read(chatServiceProvider);
