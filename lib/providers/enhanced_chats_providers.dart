...
final enhancedChatsServiceProvider = Provider<EnhancedChatsService>((ref) {
  return EnhancedChatsService();
});
...
final chatMessagesProvider = FutureProvider.family<List<EnhancedMessage>, ChatMessagesParams>((ref, params) async {
  final service = ref.read(enhancedChatsServiceProvider);
...
final sendMessageProvider = FutureProvider.family<String, SendMessageParams>((ref, params) async {
  final service = ref.read(enhancedChatsServiceProvider);
  return await service.sendMessage(params.message);
});

/// Провайдер для отправки текстового сообщения
final sendTextMessageProvider = FutureProvider.family<String, SendTextMessageParams>((ref, params) async {
  final service = ref.read(enhancedChatsServiceProvider);
...
final sendMediaMessageProvider = FutureProvider.family<String, SendMediaMessageParams>((ref, params) async {
  final service = ref.read(enhancedChatsServiceProvider);
...
final sendVoiceMessageProvider = FutureProvider.family<String, SendVoiceMessageParams>((ref, params) async {
  final service = ref.read(enhancedChatsServiceProvider);
  return await service.sendVoiceMessage(
    params.chatId,
    params.senderId,
...
final forwardMessageProvider = FutureProvider.family<String, ForwardMessageParams>((ref, params) async {
  final service = ref.read(enhancedChatsServiceProvider);
  return await service.forwardMessage(
...
final removeReactionProvider = FutureProvider.family<void, RemoveReactionParams>((ref, params) async {
  final service = ref.read(enhancedChatsServiceProvider);
...
final markMessagesAsReadProvider = FutureProvider.family<void, MarkMessagesAsReadParams>((ref, params) async {
  final service = ref.read(enhancedChatsServiceProvider);
...
final createChatProvider = FutureProvider.family<String, EnhancedChat>((ref, chat) async {
  final service = ref.read(enhancedChatsServiceProvider);
  return await service.createChat(chat);
});

/// Провайдер для создания личного чата
final createDirectChatProvider = FutureProvider.family<String, CreateDirectChatParams>((ref, params) async {
  final service = ref.read(enhancedChatsServiceProvider);
  return await service.createDirectChat(params.userId1, params.userId2);
});

/// Провайдер для создания группового чата
final createGroupChatProvider = FutureProvider.family<String, CreateGroupChatParams>((ref, params) async {
  final service = ref.read(enhancedChatsServiceProvider);
  return await service.createGroupChat(
    params.creatorId,
    params.name,
    params.memberIds,
...
final searchChatsProvider = FutureProvider.family<List<EnhancedChat>, SearchChatsParams>((ref, params) async {
  final service = ref.read(enhancedChatsServiceProvider);
  return await service.searchChats(params.userId, params.query);
});

/// Провайдер для поиска по сообщениям
final searchMessagesProvider = FutureProvider.family<List<EnhancedMessage>, SearchMessagesParams>((ref, params) async {
  final service = ref.read(enhancedChatsServiceProvider);
  return await service.searchMessages(params.chatId, params.query);
});
