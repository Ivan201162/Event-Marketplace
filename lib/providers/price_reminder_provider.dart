...
final priceReminderServiceProvider = Provider<PriceReminderService>((ref) {
  return PriceReminderService();
});
...
final priceReminderStatsProvider =
  ...
  return await service.getReminderStats();
});
...
final specialistsWithOutdatedPricesProvider =
  ...
  final service = ref.read(priceReminderServiceProvider);
  return await service.getSpecialistsWithOutdatedPrices();
});
  ...
  return specialists
      .map((specialist) => {
            ...
            'daysSinceUpdate': specialist.lastPriceUpdateAt != null
                ? DateTime.now()
                    .difference(specialist.lastPriceUpdateAt!)
                    .inDays
                : null,
          })
      .toList();
