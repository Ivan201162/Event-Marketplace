...
List<Map<String, dynamic>> _getTestChats() => [
  {
    ...
    'messages': [
      ...
      },
      {
        ...
        'timestamp': DateTime.now().subtract(const Duration(hours: 1, minutes: 45)).toIso8601String(),
        'isRead': true,
      },
      {
        'id': 'msg_3',
  ...
  },
  {
    ...
    'messages': [
      ...
      },
      {
        ...
        'timestamp': DateTime.now().subtract(const Duration(hours: 3, minutes: 30)).toIso8601String(),
        'isRead': true,
      },
      {
        'id': 'msg_9',
  ...
  },
  {
    ...
    'messages': [
      ...
      },
      {
        ...
        'timestamp': DateTime.now().subtract(const Duration(hours: 4, minutes: 30)).toIso8601String(),
        'isRead': true,
      },
      {
        'id': 'msg_15',
