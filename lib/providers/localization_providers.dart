...
final localizationSettingsProvider = StateProvider<LocalizationSettings?>((ref) {
  return null;
});
...
final availableLocalizationsProvider = StateProvider<List<LocalizationModel>>((ref) {
  return [];
});
...
final localizationStatsProvider = FutureProvider.family<LocalizationStats, String>((ref, languageCode) {
  return ref.watch(localizationServiceProvider).getLocalizationStats(languageCode);
});

/// Провайдер всех статистик локализации
final allLocalizationStatsProvider = FutureProvider<List<LocalizationStats>>((ref) {
...
final updateLocalizationSettingsProvider = FutureProvider.family<void, LocalizationSettings>((ref, settings) async {
  final service = ref.watch(localizationServiceProvider);
...
final exportTranslationsProvider = FutureProvider.family<Map<String, dynamic>, String>((ref, languageCode) {
  return ref.watch(localizationServiceProvider).exportTranslations(languageCode);
});

/// Провайдер для импорта переводов
final importTranslationsProvider = FutureProvider.family<void, Map<String, dynamic>>((ref, data) async {
  final service = ref.watch(localizationServiceProvider);
...
final getLanguageByCodeProvider = Provider<SupportedLanguage Function(String)>((ref) {
...
final getLanguageDisplayNameProvider = Provider<String Function(String, bool)>((ref) {
...
final currencyFormatProvider = Provider<String Function(num, String, String)>((ref) {
