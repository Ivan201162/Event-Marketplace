...
final chatMessagesProvider = StreamProvider.family<QuerySnapshot, String>((ref, chatId) {
  return OptimizedFirestoreService.getCollectionStream(
...
final specialistProfileProvider = StreamProvider.family<DocumentSnapshot?, String>((ref, specialistId) {
  return Stream.fromFuture(
...
final eventDetailsProvider = StreamProvider.family<DocumentSnapshot?, String>((ref, eventId) {
  return Stream.fromFuture(
...
final ideaDetailsProvider = StreamProvider.family<DocumentSnapshot?, String>((ref, ideaId) {
  return Stream.fromFuture(
...
final bookingDetailsProvider = StreamProvider.family<DocumentSnapshot?, String>((ref, bookingId) {
  return Stream.fromFuture(
