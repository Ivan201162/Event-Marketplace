...
class SearchSortingNotifier extends Notifier<sorting_utils.SpecialistSorting> {
  ...
  void setSortBy(sorting_utils.SpecialistSortOption sortOption) {
...
final searchSettingsProvider = Provider<Map<String, dynamic>>((ref) {
  ...
  return {
    ...
    'sorting': {
      ...
      'isAscending': sorting.isAscending.toString(),
    },
...
/// Провайдер для подсчета активных фильтров
final activeFiltersCountProvider = Provider<int>((ref) {
  ...
  if (filters.availableDate != null) count++;
...
final specialistCategoriesProvider = Provider<List<String>>(
  (ref) => [
    'Фотограф',
    'Видеограф',
    'Организатор',
