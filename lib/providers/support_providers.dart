...
final userTicketsProvider = StreamProvider.family<List<SupportTicket>, String>((ref, userId) {
...
final ticketProvider = FutureProvider.family<SupportTicket?, String>((ref, ticketId) {
...
final faqProvider = StreamProvider.family<List<FAQItem>, SupportCategory?>((ref, category) {
