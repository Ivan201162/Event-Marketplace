      ...
      children: [
        ...
        Wrap(
          ...
          children: [
            ...
            ...SpecialistCategory.values.map((category) => _buildFilterChip(
  ...
  Widget _buildStylesFilter() => Column(
      ...
      children: [
        ...
        Wrap(
          spacing: 8,
          runSpacing: 8,
          children: _availableStyles.map((style) => _buildFilterChip(
              label: style,
      ...
      children: [
        ...
        DropdownButtonFormField<SpecialistSortOption>(
          ...
          items: [
            ...
            ...SpecialistSortOption.values.map((sort) => DropdownMenuItem<SpecialistSortOption>(
                value: sort,
