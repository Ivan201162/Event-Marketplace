...
class _SmartSearchFiltersState extends State<SmartSearchFilters> {
  ...
  Widget _buildDateFilter() => Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
      const Text('Дата мероприятия', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600)),
      const SizedBox(height: 8),
      InkWell(
        onTap: _selectDate,
        child: Container(
            ...
            children: [
              ...
              Text(
                widget.selectedDate != null
                    ...
                    : 'Выберите дату',
                style: TextStyle(color: widget.selectedDate != null ? Colors.black : Colors.grey),
              ),
              const Spacer(),
  ...
  Widget _buildStylesFilter() => Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
      const Text('Стиль мероприятия', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600)),
      const SizedBox(height: 8),
      Wrap(
        spacing: 8,
        runSpacing: 8,
      ...
      DropdownButtonFormField<SpecialistSortOption>(
        ...
        items: [
          ...
          ...SpecialistSortOption.values.map(
            (sort) => DropdownMenuItem<SpecialistSortOption>(value: sort, child: Text(sort.label)),
          ),
        ],
