...
class SpecialistPriceStatsWidget extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return Consumer(
      builder: (context, ref, child) {
        return ref.watch(specialistPriceStatsProvider(specialistId)).when(
              data: (stats) {
                if (stats == null) {
                ...
                return ResponsiveCard(
                  child: Column(
                    ...
                    children: [
                      ...
                      ...stats.categoryStats.values.map((categoryStats) =>
  ...
  Widget _buildOverallStats(SpecialistPriceAggregate stats) {
    return Container(
  ...
  Widget _buildCategoryStatsCard(SpecialistPriceStats stats) {
    return Container(
    ...
    return Column(
      ...
      children: [
        ...
        Wrap(
          spacing: 8,
          runSpacing: 4,
          children: priceDistribution.entries.map((entry) {
            return Container(
...
final specialistPriceStatsProvider =
  ...
  return await service.getSpecialistPriceStats(specialistId);
});

/// Провайдер для сервиса статистики цен
final specialistPriceStatsServiceProvider =
    Provider<SpecialistPriceStatsService>((ref) {
  return SpecialistPriceStatsService();
});
