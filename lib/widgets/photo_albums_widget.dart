      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('Создать альбом', style: TextStyle(color: Theme.of(context).colorScheme.primary)),
          ],
        ),
      ),
    ),
          ...
          Expanded(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                image: DecorationImage(image: NetworkImage(album.coverImageUrl), fit: BoxFit.cover),
              ),
              child: Stack(
                children: [
                  // Счетчик фото
  ...
  Widget _buildImagePreview() => SizedBox(
    ...
    child: ListView.builder(
      ...
      itemBuilder: (context, index) => Padding(
        ...
        child: ClipRRect(
          borderRadius: BorderRadius.circular(8),
          child: Image.network(_selectedImages[index], width: 150, height: 200, fit: BoxFit.cover),
        ),
      ),
    ),
  );
