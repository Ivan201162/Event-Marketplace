...
class ContentCreatorCard extends ConsumerWidget {
  ...
  Widget _buildFormatChip(ContentFormat format) {
    return Container(
...
class ContentCreatorDetailWidget extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return Consumer(
      builder: (context, ref, child) {
        return ref.watch(contentCreatorProvider(creatorId)).when(
              data: (creator) {
                if (creator == null) {
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Wrap(
                              ...
                              runSpacing: 8,
                              children: creator.formats
                                  .map((format) => _buildFormatCard(format))
                                  .toList(),
                            ),
                          ],
                        ),
  ...
  Widget _buildFormatCard(ContentFormat format) {
    return Container(
  ...
  Widget _buildPortfolioGrid(List<MediaShowcase> media) {
  ...
  Widget _buildPortfolioItem(MediaShowcase item) {
...
final contentCreatorProvider =
  ...
  return await service.getContentCreator(creatorId);
});
...
final contentCreatorsProvider =
    FutureProvider.family<List<ContentCreator>, Map<String, dynamic>>(
        (ref, params) async {
  final service = ref.read(contentCreatorServiceProvider);
  return await service.getContentCreators(
...
final contentCreatorServiceProvider = Provider<ContentCreatorService>((ref) {
