...
class ChatBotMessageWidget extends ConsumerWidget {
  ...
  Widget _buildQuickReplyMessage(BuildContext context) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        // Текстовое сообщение
  ...
  Widget _buildCard(BuildContext context, BotCard card) {
    return Container(
  ...
  Widget _buildListItem(BuildContext context, BotListItem item) {
    return Container(
      margin: const EdgeInsets.only(bottom: 8),
      padding: const EdgeInsets.all(12),
      decoration: BoxDecoration(
  ...
  Widget _buildButton(BuildContext context, BotButton button) {
    return Container(
