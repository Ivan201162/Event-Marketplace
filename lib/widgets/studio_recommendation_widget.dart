      ...
      children: [
        ...
        Row(
          children: [
            ...
            Expanded(
              child: Text('Рекомендуем студию', style: Theme.of(context).textTheme.headlineSmall),
            ),
            if (recommendation.isExpired) ...[
              Container(
                ...
                child: const Text('Истекло', style: TextStyle(fontSize: 12, color: Colors.grey)),
              ),
            ],
          ],
        ),
...
class _CreateStudioRecommendationWidgetState
  ...
  List<DropdownMenuItem<PhotoStudio>> _getStudioDropdownItems() => ref
      .watch(recommendedStudiosProvider(widget.photographerId))
      .when(
      ...
      children: [
        ...
        Row(
          children: [
            ...
            const SizedBox(width: 8),
            Expanded(
              child: Text('Двойное бронирование', style: Theme.of(context).textTheme.headlineSmall),
            ),
            _buildStatusChip(),
          ],
        ),
