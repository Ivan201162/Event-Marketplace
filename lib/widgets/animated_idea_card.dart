...
class _AnimatedIdeaCardState extends ConsumerState<AnimatedIdeaCard>
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          if (widget.idea.difficulty != null) ...[
                            Container(
                              padding: const EdgeInsets.symmetric(
                                horizontal: 8,
                                vertical: 4,
                          ...
                          if (widget.idea.estimatedDuration != null) ...[
                            Container(
                              padding: const EdgeInsets.symmetric(
                                horizontal: 8,
                                vertical: 4,
                          ...
                          if (widget.idea.requiredMaterials.isNotEmpty) ...[
                            Container(
                              padding: const EdgeInsets.symmetric(
                                horizontal: 8,
                                vertical: 4,
                              ...
                              child: Text(
                                '${widget.idea.requiredMaterials.length} материалов',
                                style: TextStyle(
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  const SizedBox(width: 4),
                                  Text(
                                    widget.idea.savesCount.toString(),
                                    style: TextStyle(
                                      color: Colors.grey[600],
                                      fontWeight: FontWeight.w500,
                                    ),
                          ...
                          if (widget.idea.viewsCount > 0)
                            Row(
                              ...
                              children: [
                                ...
                                const SizedBox(width: 4),
                                Text(
                                  widget.idea.viewsCount.toString(),
                                  style: TextStyle(
                                    color: Colors.grey[600],
                                    fontSize: 12,
                                  ),
  ...
  void _showReportDialog() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        title: const Text('Пожаловаться на идею'),
        content: const Text(
