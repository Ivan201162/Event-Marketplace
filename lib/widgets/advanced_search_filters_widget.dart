...
class _AdvancedSearchFiltersWidgetState extends ConsumerState<AdvancedSearchFiltersWidget> {
  ...
  Widget _buildLocationFilters() => SingleChildScrollView(
  ...
  Widget _buildCategoryFilters() => SingleChildScrollView(
    padding: const EdgeInsets.all(16),
    child: Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
  ...
  Widget _buildPriceFilters() => SingleChildScrollView(
    padding: const EdgeInsets.all(16),
    child: Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('Цена и опыт', style: Theme.of(context).textTheme.titleLarge),
        const SizedBox(height: 16),
        ...
        Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [Text('${_filters.minExperience} лет'), Text('${_filters.maxExperience} лет')],
        ),
        ...
        DropdownButtonFormField<ExperienceLevel>(
          ...
          items: [
            ...
            ...ExperienceLevel.values.map(
              (level) =>
                  DropdownMenuItem<ExperienceLevel>(value: level, child: Text(level.displayName)),
            ),
          ],
  ...
  Widget _buildAdvancedFilters() => SingleChildScrollView(
    padding: const EdgeInsets.all(16),
    child: Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
