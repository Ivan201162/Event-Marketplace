...
class MessageBubbleWidget extends StatelessWidget {
        ...
        children: [
          ...
          Flexible(
            child: Column(
              ...
              children: [
                // Ответ на сообщение
                if (message.replyTo != null) ...[_buildReplyPreview(), const SizedBox(height: 4)],
                ...
                // Реакции
                if (message.reactions.isNotEmpty) ...[const SizedBox(height: 4), _buildReactions()],
              ],
            ),
          ),
          if (isCurrentUser && showAvatar) ...[
    ...
    child: Column(
      ...
      children: [
        ...
        if (message.text.isNotEmpty) ...[
          Text(
            message.text,
            style: TextStyle(color: isCurrentUser ? Colors.white : Colors.black87, fontSize: 14),
          ),
  ...
  Widget _buildAttachments() => Column(
  ...
  Widget _buildImageAttachment(MessageAttachment attachment) => ClipRRect(
    borderRadius: BorderRadius.circular(8),
    child: Image.network(
      attachment.url,
      width: 200,
  ...
  Widget _buildStickerAttachment(MessageAttachment attachment) => Container(
    width: 100,
    height: 100,
  ...
  Widget _buildMessageMetadata() => Row(
    mainAxisSize: MainAxisSize.min,
    children: [
      // Время отправки
