...
class _IdeaCardWidgetState extends ConsumerState<IdeaCardWidget> {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          if (widget.idea.budget != null || widget.idea.timeline != null || widget.idea.location != null)
            _buildIdeaDetails(),
        ],
      ),
    );
        ...
        SizedBox(
          ...
          child: PageView.builder(
            ...
            itemBuilder: (context, index) {
              return _buildSingleMedia(widget.idea.media[index]);
            },
          ),
        ),
        if (widget.idea.media.length > 1)
  ...
  Widget _buildCommentsPreview() {
    return Padding(
      padding: const EdgeInsets.symmetric(horizontal: 16),
      child: Column(
        children: widget.idea.comments.take(2).map((comment) {
          return Padding(
            padding: const EdgeInsets.only(bottom: 4),
            child: RichText(
              text: TextSpan(
