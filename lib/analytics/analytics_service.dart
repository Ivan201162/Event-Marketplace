...
class AnalyticsEvent {
  ...
  @override
  String toString() {
    return 'AnalyticsEvent(type: ${type.name}, parameters: $parameters, timestamp: $timestamp)';
  }
}
...
class AnalyticsService {
  ...
  Future<void> logPerformance({
    ...
    await logEventWithParams(
      AnalyticsEventType.slowOperation,
      {
        'operation': operation,
  ...
  Future<void> logEventEvent(AnalyticsEventType type, {
  ...
  Future<void> logChatEvent(AnalyticsEventType type, {
  ...
  Future<void> logPaymentEvent(AnalyticsEventType type, {
  ...
  Future<void> logCustomEvent({
    ...
    await logEventWithParams(
      AnalyticsEventType.customEvent,
      {
