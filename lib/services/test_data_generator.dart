...
class TestDataGenerator {
  ...
  static Future<void> _clearTestData() async {
    final collections = ['users', 'specialists', 'feed', 'ideas', 'notifications', 'chats', 'requests'];
  ...
  static Future<void> _generateUsersAndSpecialists() async {
    final users = [
      ...
      },
      {
        ...
        'rating': 4.9,
        'pricePerHour': 3000,
        'description': 'Креативный видеограф, создаю незабываемые видео для любых событий.',
      },
      {
        'id': 'user_3',
        'name': 'Елена Козлова',
        ...
        'rating': 4.7,
        'pricePerHour': 2000,
        'description': 'Опытный организатор мероприятий. Помогу сделать ваше событие незабываемым!',
      },
      {
        'id': 'user_4',
        'name': 'Дмитрий Волков',
        ...
        'rating': 4.6,
        'pricePerHour': 1500,
        'description': 'Профессиональный диджей с отличной музыкальной коллекцией и качественным оборудованием.',
      },
      {
        'id': 'user_5',
        'name': 'Ольга Морозова',
        ...
        'rating': 4.8,
        'pricePerHour': 1800,
        'description': 'Талантливый декоратор, создаю уникальные интерьеры для ваших мероприятий.',
      },
    ];
    ...
    final posts = [
      {
        ...
        'description': 'Красивая свадебная фотосессия в парке 🌸 #свадьба #фотограф #любовь',
      ...
      },
      {
        ...
        'description': 'Новый клип готов! Спасибо за доверие 🎬 #видеограф #клип #творчество',
      ...
      },
      {
        ...
        'description': 'Организовала корпоратив на 100 человек. Все прошло идеально! 🎉 #корпоратив #организатор',
      ...
      },
      {
        ...
        'description': 'Отличная вечеринка! Музыка была на высоте 🎵 #диджей #вечеринка #музыка',
      ...
      },
      {
        ...
        'description': 'Декор для детского дня рождения готов! 🎈 #декор #деньрождения #дети',
    ...
    final ideas = [
      {
        ...
        'description': 'Идея для создания атмосферных фотографий в винтажном стиле с использованием старинных автомобилей и костюмов.',
      ...
      },
      {
        ...
        'description': 'Организация тематического корпоратива с музыкой, костюмами и декором в стиле диско.',
      ...
      },
      {
        ...
        'description': 'Веселая программа с аниматорами, клоунами и конкурсами для детей от 5 до 10 лет.',
      ...
      },
      {
        ...
        'description': 'Создание футуристического видео с неоновыми эффектами и современной музыкой.',
      ...
      },
      {
        ...
        'description': 'Организация летней вечеринки с живой музыкой, барбекю и танцами под звездами.',
