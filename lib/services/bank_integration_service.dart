...
class BankIntegrationService {
  ...
  static const String _sbpMerchantId = 'test_merchant_id';
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        return PaymentResult(
          ...
          status: _mapYooKassaStatus(responseData['status']),
  ...
  Future<PaymentStatus> checkYooKassaPaymentStatus(String transactionId) async {
    try {
      ...
      if (response.statusCode == 200) {
        final responseData = jsonDecode(response.body);
        return _mapYooKassaStatus(responseData['status']);
      } else {
  ...
  Future<PaymentStatus> checkSBPPaymentStatus(String transactionId) async {
    try {
      ...
      if (response.statusCode == 200) {
        final responseData = jsonDecode(response.body);
        return _mapSBPStatus(responseData['status']);
      } else {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        return RefundResult(
          ...
          status: _mapYooKassaRefundStatus(responseData['status']),
          metadata: responseData,
        );
      } else {
  ...
  Future<RefundResult> createSBPRefund({
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        return RefundResult(
          success: true,
          refundId: responseData['refund_id'],
          status: 'pending',
          metadata: responseData,
        );
      } else {
