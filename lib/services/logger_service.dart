...
class LoggerService {
  ...
  void apiRequest(String method, String url, {Map<String, dynamic>? headers, Map<String, dynamic>? body}) {
  ...
  void firebase(String operation, {String? collection, String? documentId, Map<String, dynamic>? data}) {
  ...
  void firebaseError(String operation, Object error, {String? collection, String? documentId, StackTrace? stackTrace}) {
    final message = 'Firebase Error: $operation';
    _log(LogLevel.error, message, tag: 'FIREBASE_ERROR', error: error, stackTrace: stackTrace, data: {
      'operation': operation,
      if (collection != null) 'collection': collection,
      if (documentId != null) 'documentId': documentId,
    });
  ...
  void authError(String action, Object error, {String? userId, StackTrace? stackTrace}) {
    ...
    _log(LogLevel.error, message, tag: 'AUTH_ERROR', error: error, stackTrace: stackTrace, data: {
      'action': action,
      if (userId != null) 'userId': userId,
    });
  }
  ...
  void paymentError(String action, Object error, {String? paymentId, StackTrace? stackTrace}) {
    ...
    _log(LogLevel.error, message, tag: 'PAYMENT_ERROR', error: error, stackTrace: stackTrace, data: {
      'action': action,
      if (paymentId != null) 'paymentId': paymentId,
    });
  }
  ...
  void notification(String action, {String? notificationId, String? userId, Map<String, dynamic>? data}) {
  ...
  void notificationError(String action, Object error, {String? notificationId, StackTrace? stackTrace}) {
    final message = 'Notification Error: $action';
    _log(LogLevel.error, message, tag: 'NOTIFICATION_ERROR', error: error, stackTrace: stackTrace, data: {
      'action': action,
      if (notificationId != null) 'notificationId': notificationId,
    });
  }
  ...
  void calendar(String action, {String? specialistId, String? eventId, Map<String, dynamic>? data}) {
  ...
  void calendarError(String action, Object error, {String? specialistId, StackTrace? stackTrace}) {
    ...
    _log(LogLevel.error, message, tag: 'CALENDAR_ERROR', error: error, stackTrace: stackTrace, data: {
      'action': action,
      if (specialistId != null) 'specialistId': specialistId,
    });
  }
  ...
  /// Логирование чатов
  void chat(String action, {String? chatId, String? messageId, String? userId, Map<String, dynamic>? data}) {
  ...
  void chatError(String action, Object error, {String? chatId, StackTrace? stackTrace}) {
    ...
    _log(LogLevel.error, message, tag: 'CHAT_ERROR', error: error, stackTrace: stackTrace, data: {
      'action': action,
      if (chatId != null) 'chatId': chatId,
    });
  }
  ...
  /// Логирование отзывов
  void review(String action, {String? reviewId, String? specialistId, String? customerId, Map<String, dynamic>? data}) {
  ...
  void reviewError(String action, Object error, {String? reviewId, StackTrace? stackTrace}) {
    ...
    _log(LogLevel.error, message, tag: 'REVIEW_ERROR', error: error, stackTrace: stackTrace, data: {
      'action': action,
      if (reviewId != null) 'reviewId': reviewId,
    });
  }
  ...
  void analyticsError(String action, Object error, {String? metricName, StackTrace? stackTrace}) {
    ...
    _log(LogLevel.error, message, tag: 'ANALYTICS_ERROR', error: error, stackTrace: stackTrace, data: {
      'action': action,
      if (metricName != null) 'metricName': metricName,
    });
  }
  ...
  /// Логирование поиска
  void search(String action, {String? query, Map<String, dynamic>? filters, Map<String, dynamic>? data}) {
  ...
  void searchError(String action, Object error, {String? query, StackTrace? stackTrace}) {
    ...
    _log(LogLevel.error, message, tag: 'SEARCH_ERROR', error: error, stackTrace: stackTrace, data: {
      'action': action,
      if (query != null) 'query': query,
    });
  }
  ...
  void booking(String action, {String? bookingId, String? specialistId, String? customerId, Map<String, dynamic>? data}) {
  ...
  void bookingError(String action, Object error, {String? bookingId, StackTrace? stackTrace}) {
    ...
    _log(LogLevel.error, message, tag: 'BOOKING_ERROR', error: error, stackTrace: stackTrace, data: {
      'action': action,
      if (bookingId != null) 'bookingId': bookingId,
    });
  }
