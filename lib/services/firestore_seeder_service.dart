  ...
  Future<bool> seedTestData() async {
    try {
      ...
      await _firestore.collection('specialists').doc('u_spec_1').set({
        ...
        'reviewsCount': 25,
        'pricePerHour': 5000.0,
        'description': 'Опытный ведущий с 5-летним стажем. Провожу свадьбы, корпоративы, дни рождения.',
      ...
      await _firestore.collection('specialists').doc('u_spec_2').set({
        ...
        'reviewsCount': 40,
        'pricePerHour': 3000.0,
        'description': 'Профессиональный фотограф. Специализируюсь на свадебной и семейной фотографии.',
