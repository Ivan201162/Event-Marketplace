...
class MockDataService {
  ...
  static List<Specialist> getFilteredSpecialists({String? categoryId, SpecialistFilters? filters}) {
    final specialists = categoryId != null
        ? getSpecialistsByCategory(categoryId)
        : getAllSpecialists();
  ...
  static List<Specialist> getSortedSpecialists({
    ...
    var specialists = getFilteredSpecialists(categoryId: categoryId, filters: filters);
  ...
  static bool _matchesFilters(Specialist specialist, SpecialistFilters filters) {
    // Фильтр по цене
  ...
  static List<Specialist> _getDancers() => [
    _createSpecialist(
      ...
      rating: 4.7,
      totalReviews: 76,
      imageUrl: 'https://images.unsplash.com/photo-1508700929628-666bc8bd84ea?w=400&h=400&fit=crop',
    ),
  ];
  ...
  static List<Specialist> _getCleaning() => [
    _createSpecialist(
      ...
      rating: 4.5,
      totalReviews: 78,
      imageUrl: 'https://images.unsplash.com/photo-1581578731548-c6a0c3f2f6c5?w=400&h=400&fit=crop',
    ),
  ];
