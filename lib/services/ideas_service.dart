...
class IdeasService {
  ...
  Future<String?> createIdea({
    ...
    try {
      ...
      debugdebugPrint('Ошибка создания идеи: $e');
      return null;
    }
  }
  ...
  Future<bool> updateIdea(String ideaId, Map<String, dynamic> updates) async {
    try {
      ...
      debugdebugPrint('Ошибка обновления идеи: $e');
      return false;
    }
  }
  ...
  Future<bool> deleteIdea(String ideaId) async {
    try {
      ...
      debugdebugPrint('Ошибка удаления идеи: $e');
      return false;
    }
  }
  ...
  Future<bool> toggleLike(String ideaId, String userId) async {
    try {
      ...
      debugdebugPrint('Ошибка лайка идеи: $e');
      return false;
    }
  }
  ...
  Future<bool> toggleSave(String ideaId, String userId) async {
    try {
      ...
      debugdebugPrint('Ошибка сохранения идеи: $e');
      return false;
    }
  }
  ...
  Future<bool> shareIdea(String ideaId, String userId) async {
    try {
      ...
      debugdebugPrint('Ошибка репоста идеи: $e');
      return false;
    }
  }
  ...
  Future<bool> toggleCommentLike(String commentId, String userId) async {
    try {
      ...
      debugdebugPrint('Ошибка лайка комментария: $e');
      return false;
    }
  }
  ...
  Future<File?> pickMediaFile({required bool isVideo}) async {
    try {
      ...
      debugdebugPrint('Ошибка выбора медиа файла: $e');
      return null;
    }
  }
  ...
  Future<String?> _uploadMediaFile(File file, bool isVideo) async {
    try {
      ...
      debugdebugPrint('Ошибка загрузки медиа файла: $e');
      return null;
    }
  }
  ...
  Future<String?> generateVideoThumbnail(String videoPath) async {
    try {
      ...
      debugdebugPrint('Ошибка генерации превью видео: $e');
      return null;
    }
  }
