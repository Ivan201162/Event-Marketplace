...
class DynamicPricingService {
  ...
  Future<double> getCurrentPrice({
    ...
    try {
      ...
      debugPrint('INFO: [DynamicPricingService] Price calculated: $finalPrice for $serviceType in $region');
      return finalPrice;
    } catch (e) {
  ...
  Future<void> updateDemandMetrics({
    ...
    try {
      final DemandMetrics metrics = DemandMetrics(
        ...
        timestamp: DateTime.now(),
        demandLevel: 1.0, // Будет рассчитан автоматически
      ...
      debugPrint('INFO: [DynamicPricingService] Demand metrics updated for $serviceType in $region');
    } catch (e) {
