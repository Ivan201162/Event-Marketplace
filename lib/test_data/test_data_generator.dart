...
class TestDataGenerator {
  ...
  static const List<String> russianCities = [
    ...
    'Владимир', 'Калуга', 'Чита', 'Смоленск', 'Волжский',
    'Череповец', 'Курган', 'Орел', 'Вологда', 'Саранск',
    'Тамбов', 'Стерлитамак', 'Грозный', 'Якутск', 'Кострома',
    'Комсомольск-на-Амуре', 'Петрозаводск', 'Таганрог', 'Нижневартовск', 'Йошкар-Ола',
    'Братск', 'Новороссийск', 'Дзержинск', 'Шахты', 'Орск',
    'Ангарск', 'Сыктывкар', 'Нижнекамск', 'Старый Оскол', 'Бийск',
    'Прокопьевск', 'Рыбинск', 'Балково', 'Северодвинск', 'Армавир',
    'Подольск', 'Королев', 'Южно-Сахалинск', 'Петропавловск-Камчатский', 'Мурманск',
    'Химки', 'Мытищи', 'Люберцы', 'Красногорск', 'Электросталь',
    'Коломна', 'Одинцово', 'Домодедово', 'Серпухов', 'Щелково',
    'Орехово-Зуево', 'Новомосковск', 'Златоуст', 'Камышин', 'Соликамск',
    'Великий Новгород', 'Псков', 'Благовещенск', 'Энгельс', 'Мичуринск',
    'Первоуральск', 'Рубцовск', 'Железнодорожный', 'Лыткарино', 'Жуковский',
    'Ковров', 'Елец', 'Ачинск', 'Евпатория', 'Кисловодск',
    'Пятигорск', 'Минеральные Воды', 'Ессентуки', 'Железноводск'
  ];
  ...
  static const List<String> maleNames = [
    ...
    'Арсений', 'Иван', 'Денис', 'Евгений', 'Данил', 'Тимур', 'Владислав',
    'Игорь', 'Владимир', 'Павел', 'Руслан', 'Марк', 'Константин', 'Тимофей',
    'Николай', 'Степан', 'Федор', 'Георгий', 'Лев', 'Виктор', 'Антон',
    'Глеб', 'Семен', 'Ярослав', 'Захар', 'Богдан', 'Савелий', 'Давид'
  ];

  /// Женские имена
  static const List<String> femaleNames = [
    'Анна', 'Мария', 'Елена', 'Дарья', 'Алина', 'Ирина', 'Екатерина',
    'Арина', 'Полина', 'Ольга', 'Юлия', 'Татьяна', 'Наталья', 'Виктория',
    'Елизавета', 'Анастасия', 'Валерия', 'Варвара', 'Александра', 'Вероника',
    'София', 'Кристина', 'Алиса', 'Ксения', 'Милана', 'Диана', 'Маргарита',
    'Карина', 'Стефания', 'Эмилия', 'Кира', 'Камила', 'Ева', 'Амелия',
    'Ульяна', 'Лилия', 'Злата', 'Мирослава', 'Агата', 'Василиса', 'Нина',
    'Светлана', 'Людмила', 'Любовь', 'Галина', 'Тамара'
  ];

  /// Фамилии
  static const List<String> lastNames = [
    'Иванов', 'Петров', 'Сидоров', 'Смирнов', 'Кузнецов', 'Попов', 'Лебедев',
    'Козлов', 'Новиков', 'Морозов', 'Соколов', 'Волков', 'Федоров', 'Михайлов',
    'Николаев', 'Захаров', 'Степанов', 'Сергеев', 'Владимиров', 'Фролов',
    ...
    'Сидоров', 'Матвеев', 'Титов', 'Марков', 'Миронов', 'Крылов'
  ];
  ...
  Future<List<Booking>> generateBookings(
    ...
    for (final customer in customers) {
      ...
      for (int i = 0; i < specialistCount && i < selectedSpecialists.length; i++) {
  ...
  Future<void> _printSampleData() async {
    ...
    try {
      // Пример специалиста
      final specialistSnapshot = await _firestore
