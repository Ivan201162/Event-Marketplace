...
class MockData {
  ...
  static List<Specialist> get specialists => [
    ...
    Specialist(
      ...
      location: 'Караганда',
      specialties: const ['Свадебный декор', 'Оформление мероприятий', 'Флористика'],
      createdAt: DateTime.now(),
      updatedAt: DateTime.now(),
    ),
  ];
  ...
  static List<EnhancedFeedPost> get feedPosts => [
    ...
    const EnhancedFeedPost(
      ...
      content: 'Декор для детского дня рождения в стиле "Маленький принц". Получилось волшебно!',
      media: [
        FeedPostMedia(
          id: 'media5_1',
          type: 'image',
