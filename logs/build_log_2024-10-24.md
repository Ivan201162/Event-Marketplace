...
1. **Firestore Security Rules и Индексы**
2. **Очистка, зависимости, автоинкремент версии и коммит**
3. **Анализ и исправление ошибок**
4. **Сборка и установка на Android**
5. **Авто-проверка UI по чек-листу (интеграционные тесты)**
6. **Финальный отчёт и фиксация**