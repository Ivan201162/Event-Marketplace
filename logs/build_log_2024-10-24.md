...
**Выполнено:**
- ✅ `flutter build apk --debug --no-shrink --target=lib/main_minimal.dart` - сборка успешна
...
- ✅ Скриншот сохранен: `artifacts/screens/app_installed.png`

**Созданные файлы:**
- `lib/main_minimal.dart` - минимальная версия приложения
- `lib/core/app_router_minimal.dart` - упрощенный роутер
- `lib/models/message_status.dart` - статусы сообщений
- `lib/models/story_privacy.dart` - приватность историй
- `lib/models/story_type.dart` - типы историй
...
2. **Повторная сборка и установка на Android**
3. **Авто-проверка UI по чек-листу (интеграционные тесты)**
4. **Финальный отчёт и фиксация**