...
1. **Очистка, зависимости, автоинкремент версии и коммит**
2. **Анализ и исправление ошибок**
3. **Сборка и установка на Android**
4. **Авто-проверка UI по чек-листу (интеграционные тесты)**
5. **Финальный отчёт и фиксация**