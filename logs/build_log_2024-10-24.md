...
3. **Firestore Security Rules и Индексы**
4. **Очистка, зависимости, автоинкремент версии и коммит**
5. **Анализ и исправление ошибок**
6. **Сборка и установка на Android**
7. **Авто-проверка UI по чек-листу (интеграционные тесты)**
8. **Финальный отчёт и фиксация**