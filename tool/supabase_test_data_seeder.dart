...
Future<void> _createTestProfiles(SupabaseClient supabase) async {
  final profiles = [
    ...
    },
    {
      ...
      'bio':
          'DJ и ведущая мероприятий. Создаю незабываемую атмосферу на ваших праздниках.',
    ...
    },
    {
      ...
      'city': 'Казань',
      'bio':
          'Видеограф и монтажер. Снимаю свадьбы, корпоративы и рекламные ролики.',
    ...
    },
    {
      ...
      'city': 'Екатеринбург',
      'bio':
          'Декоратор и флорист. Создаю красивые интерьеры для ваших мероприятий.',
...
Future<void> _createFollows(SupabaseClient supabase) async {
  ...
  for (final follow in follows) {
    try {
      ...
      print(
          '  ✅ Подписка создана: ${follow['follower_id']} → ${follow['following_id']}');
    } catch (e) {
...
Future<void> _createChatsAndMessages(SupabaseClient supabase) async {
  ...
  for (final participant in participants) {
    try {
      ...
      print(
          '  ✅ Участник добавлен в чат: ${participant['user_id']} → ${participant['chat_id']}');
    } catch (e) {
  ...
  final messages = [
    {
      ...
      'sender_id': 'user1',
      'text':
          'Привет! Интересует фотосъемка свадьбы на 15 июня. Можете рассказать о ваших услугах?',
    },
    {
      'chat_id': 'chat1',
      'sender_id': 'user2',
      'text':
          'Здравствуйте! Конечно, расскажу подробнее. Сколько гостей планируется?',
    },
    {
      'chat_id': 'chat1',
      'sender_id': 'user1',
    ...
    },
    {
      ...
      'sender_id': 'user2',
      'text':
          'Отлично! У меня есть опыт съемки в таких локациях. Пришлю портфолио.',
    },
    {
      'chat_id': 'chat2',
      'sender_id': 'user1',
      'text':
          'Добрый день! Нужна видеосъемка корпоратива. Какие у вас расценки?',
    },
    {
      'chat_id': 'chat2',
      'sender_id': 'user3',
      'text':
          'Привет! Расценки зависят от продолжительности и сложности. Когда планируется мероприятие?',
    },
    {
      'chat_id': 'chat3',
      'sender_id': 'user2',
      'text':
          'Привет! Видела ваши работы по декору. Очень красиво! Можете помочь с оформлением детского дня рождения?',
    },
    {
      'chat_id': 'chat3',
      'sender_id': 'user4',
      'text':
          'Спасибо! Конечно помогу. Какой возраст именинника и какая тематика?',
    },
  ];
