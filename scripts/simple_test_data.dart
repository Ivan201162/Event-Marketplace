...
void main() {
  ...
  final bookings = [
    ...
    },
    {
      ...
      'eventDate': DateTime.now().add(const Duration(days: 25)).toIso8601String(),
      'totalPrice': 35000.0,
      'prepayment': 17500.0,
      'status': 'confirmed',
    ...
    },
    {
      ...
      'eventDate': DateTime.now().add(const Duration(days: 10)).toIso8601String(),
      'totalPrice': 25000.0,
      'prepayment': 12500.0,
      'status': 'pending',
  ...
  final chats = [
    ...
    },
    {
      ...
      'lastMessageTime': DateTime.now().subtract(const Duration(minutes: 45)).toIso8601String(),
      'createdAt': DateTime.now().subtract(const Duration(days: 4)).toIso8601String(),
      'updatedAt': DateTime.now().subtract(const Duration(minutes: 45)).toIso8601String(),
    },
    {
  ...
  final messages = [
    ...
    },
    {
      ...
      'status': 'read',
      'timestamp': DateTime.now().subtract(const Duration(days: 3, hours: 1)).toIso8601String(),
    },
    {
      'senderId': 'user1',
      'senderName': 'Анна Петрова',
    ...
    },
    {
      ...
      'status': 'read',
      'timestamp': DateTime.now().subtract(const Duration(days: 2, hours: 20)).toIso8601String(),
    },
    {
      'senderId': 'user1',
      'senderName': 'Анна Петрова',
  ...
  print('3. Создайте коллекции "bookings", "chats" и добавьте документы с данными выше');
  print('4. Для сообщений создайте подколлекцию "messages" в каждом чате');
  print('5. Убедитесь, что пользователи user1, user2, user3, user4 и специалисты specialist1, specialist2 существуют в вашей системе аутентификации');
}