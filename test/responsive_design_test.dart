...
void main() {
  group('Responsive Design Tests', () {
    test('ResponsiveUtils should return correct screen types', () {
      ...
      expect(
        ResponsiveUtils.getScreenType(1600),
        equals(ScreenType.largeDesktop),
      );
    });
    ...
    test('ResponsiveUtils should return correct grid columns', () {
      ...
      expect(
        ResponsiveUtils.getGridColumns(1200),
        equals(4),
      ); // largeDesktop = 4 columns
    ...
    test('ResponsiveUtils should return correct font sizes', () {
      ...
      expect(
        ResponsiveUtils.getTitleFontSize(1200),
        equals(36.0),
      ); // largeDesktop = 36
    ...
    test('ResponsiveUtils should return correct padding', () {
      ...
      expect(
        desktopPadding,
        equals(const EdgeInsets.all(48)),
      ); // largeDesktop = 48
